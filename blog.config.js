...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '可夫小子', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '关注AIGC、读书和自媒体', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://koffuxu.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'ChatGPT, Notion, 自媒体', // 网站关键词 英文逗号隔开
